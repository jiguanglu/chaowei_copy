...
def data2json(img_path,json_output_path):
    ...
    if len(imagelist) !=0:
        ...
        for i in imagelist:
            ...
            k = k + 1
            darknet_out = output_points(i)
            points = darknet_out[0]
            # 生成pic的ID，以后需要修改
            ...
            picContentList.append(PicContentList(innerPointCount=6, innerTopDegreeName='sas', picId=pic_id, picIndex= pic_index, picUrl=url+str1+pic_name,
